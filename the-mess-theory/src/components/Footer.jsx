      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  text-zinc-300 bg-zinc-800">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
              <span className="text-xl font-bold tracking-wide uppercase text-yellow-400">
                The-Mess-Thoery
              </span>
            <div className="mt-6 lg:max-w-sm">
                <p className="text-sm">
                    The Mess Theory is dedicated to providing students with a seamless dining experience.
                </p>
                <br />
                <p className="text-sm"> 
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                href="https://maps.app.goo.gl/qLa5yBTbcwoDvuoFA"
                target="_blank"
